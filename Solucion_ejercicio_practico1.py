...
clave_departamento = int(input("Por favor introduce la clave de departamento: "))
antiguedad_empleado = float(input("Por favor introduce los años laborados: "))
...
if clave_departamento == 1:
    ...
    if antiguedad_empleado >= 1 and antiguedad_empleado < 2:
        ...
        print("Aun no tienes derecho a vacaciones.")
